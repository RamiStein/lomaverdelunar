  ...
  return (
    <div className="relative overflow-hidden pb-16">
      ...
      <div className="max-w-5xl mx-auto px-4 mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/70 p-6 sm:p-8 rounded-3xl border-2 border-loma-green/60 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed mb-4">
              Conoce a los artesanos, productores de alimentos agroecológicos, terapeutas y artistas de Loma Verde con contacto directo por WhatsApp e Instagram.
            </p>
          </div>
